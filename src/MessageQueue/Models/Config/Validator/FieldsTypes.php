...
namespace Maginium\Framework\MessageQueue\Models\Config\Validator;

use LogicException;
use Magento\Framework\MessageQueue\Topology\Config\Validator\FieldsTypes as BaseFieldsTypes;

/**
 * Consumer config data validator for fields types.
 */
class FieldsTypes extends BaseFieldsTypes
{
    /**
     * {@inheritdoc}
     */
