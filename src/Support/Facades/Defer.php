 ...
 *
 * @method static DeferredCallback|DeferredCallbackCollection execute(?callable $callback = null, ?string $name = null, bool $always = false) Defer execution of the given callback.
