 ...
 * @method static void setGenerator(GeneratorInterface $generator)Set a custom generator for the avatar creation, allowing customization of the avatar generation process.
