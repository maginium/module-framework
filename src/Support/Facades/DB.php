...
/**
 * @method static \Maginium\Framework\Database\Connections\Connection connection(string|null $name = null)
 ...
 * @method static \Maginium\Framework\Database\Connections\Connection reconnect(string|null $name = null)
 ...
 * @method static \Maginium\Framework\Database\Connections\Connection beforeStartingTransaction(\Closure $callback)
 * @method static \Maginium\Framework\Database\Connections\Connection beforeExecuting(\Closure $callback)
 ...
 * @method static \Maginium\Framework\Database\Connections\Connection setRecordModificationState(bool $value)
 * @method static void forgetRecordModificationState()
 * @method static \Maginium\Framework\Database\Connections\Connection useWriteConnectionWhenReading(bool $value = true)
 * @method static \PDO getPdo()
 * @method static \PDO|\Closure|null getRawPdo()
 * @method static \PDO getReadPdo()
 * @method static \PDO|\Closure|null getRawReadPdo()
 * @method static \Maginium\Framework\Database\Connections\Connection setPdo(\PDO|\Closure|null $pdo)
 * @method static \Maginium\Framework\Database\Connections\Connection setReadPdo(\PDO|\Closure|null $pdo)
 ...
 * @method static \Maginium\Framework\Database\Connections\Connection setQueryGrammar(\Illuminate\Database\Query\Grammars\Grammar $grammar)
 * @method static \Illuminate\Database\Schema\Grammars\Grammar getSchemaGrammar()
 * @method static \Maginium\Framework\Database\Connections\Connection setSchemaGrammar(\Illuminate\Database\Schema\Grammars\Grammar $grammar)
 * @method static \Illuminate\Database\Query\Processors\Processor getPostProcessor()
 * @method static \Maginium\Framework\Database\Connections\Connection setPostProcessor(\Illuminate\Database\Query\Processors\Processor $processor)
 * @method static \Illuminate\Contracts\Events\Dispatcher getEventDispatcher()
 * @method static \Maginium\Framework\Database\Connections\Connection setEventDispatcher(\Illuminate\Contracts\Events\Dispatcher $events)
 * @method static void unsetEventDispatcher()
 * @method static \Maginium\Framework\Database\Connections\Connection setTransactionManager(\Illuminate\Database\DatabaseTransactionsManager $manager)
 ...
 * @method static \Maginium\Framework\Database\Connections\Connection setDatabaseName(string $database)
 * @method static \Maginium\Framework\Database\Connections\Connection setReadWriteType(string|null $readWriteType)
 * @method static string getTablePrefix()
 * @method static \Maginium\Framework\Database\Connections\Connection setTablePrefix(string $prefix)
