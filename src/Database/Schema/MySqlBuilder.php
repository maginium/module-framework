 ...
 * MySqlBuilder class.
 *
 * This class extends the functionality of the MySqlBuilder from the Maginium\Framework\Database\Schema
 * and implements the BuilderInterface from Maginium\Framework\Database\Interfaces.
 * It is designed to handle schema operations for MySQL databases within the Maginium Framework.
 */
class MySqlBuilder extends Builder implements BuilderInterface
{
    /**
