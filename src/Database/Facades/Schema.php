 ...
 * @method static \Maginium\Framework\Database\Connections\Connection getConnection()
 * @method static BuilderInterface setConnection(\Maginium\Framework\Database\Connections\Connection $connection)
