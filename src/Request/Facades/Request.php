...
namespace Maginium\Framework\Request\Facades;
 ...
 *
 * @method static string getModuleName() Retrieve the module name from the request.
 * @method static mixed getBody() Get the parsed content of the body (e.g., JSON decoded).
 * @method static string getRawBody() Get the raw body content as it was received, without processing.
 ...
 * @method static \Laminas\Http\Headers getHeaders() Retrieve all the headers from the request. Returns an instance of the `Headers` class, which provides access to request headers. The `Headers` object can be used to interact with header names and values, including standard headers like "X-Request-ID", "Content-Type", etc.
 ...
 * @method static string|array|null old(string|null $key = null, \Maginium\Framework\Database\Eloquent\Model|string|array|null $default = null)
