 ...
 */
#[AsCommand(MakeCommands::ADMIN_CONTROLLER)]
class AdminControllerCommand extends GeneratorCommand
{
    ...
    protected function handle(): int
    {
        try {
            ...
            ConsoleOutput::success(Str::format('%1 admin controller generated successfully.', $controller));
