...
use Maginium\Framework\Crud\Repository as BaseRepository;
 ...
 * Class Repository.
 *
 * A generic repository class for managing CRUD operations for models.
...
class Repository extends BaseRepository implements RepositoryInterface
{
    ...
    private function handleDynamicCall($method, $parameters)
    {
        ...
        if (Reflection::methodExists($model, $method)) {
